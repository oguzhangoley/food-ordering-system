...
//        when(paymentOutboxRepository.save(any(OrderPaymentOutboxMessage.class))).thenReturn(getOrderPaymentOutboxMessage());
    ...
    public void testCreateOrderWithWrongTotalPrice() {
        ...
        assertEquals("Total price : 250.00is not equal to Order items total : 200.00 !", orderDomainException.getMessage());
    }
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price : 210.00is not valid for product " + PRODUCT_ID, orderDomainException.getMessage());
    }
